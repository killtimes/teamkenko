...
//    const _globalLocale = 'LocalTime_locale';
    ...
    public $localTimeZone = 'Europe/London';
    public $localLocale = 'en_GB';
...
//        $locale = Yii::app()->getGlobalState(self::_globalLocale);
    ...
    public function fromUTC($servertimestamp, $format = 'd M Y H:i:s T')
    {
    ...
    public function getLocalDateTimeNow(){
        return new DateTime(null, $this->localDateTimeZone);
    }
    ...
    public function getTimestamp($servertime = 'now')
    {
        $date = new DateTime($servertime, $this->getServerDateTimeZone());

        return $date->getTimestamp();
    }


    public function getUtcNowDateTime()
    {
        $date = new DateTime(null, $this->getServerDateTimeZone());
