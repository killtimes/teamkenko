<li class="list-group-item">
  <span class="pull-right text-muted time-line">
    ...
    <i class="glyphicon glyphicon-thumbs-down icon-activity text-muted"></i> <a><strong><?php echo Profile::model()->getById($model->action_source)->getFullName(); ?></strong></a> rejected this task.
