...
$this->breadcrumbs = array(
    ...
    $g => array('/report/departmentSummary/dailyDepartment','department' => $this->department),
    $name
);
        ...
        <?php if (!$full) { ?>
            <legend>Department Summary: <?php echo $g; ?> - <?php echo $name; ?> (<?php echo $date; ?>)
                <a title="Fullscreen" class="btn btn-link btn-sm pull-right"
                   href="<?php echo $this->createUrl('/report/departmentSummary/dailyStaff', array('full' => 1,'staff'=>$staff, 'department' => $this->department)); ?>"><i
        ...
        <?php } else { ?>
            ...
            <legend class="text-primary">Teamkenko Department Summary
                ...
                <a title="Exit fullscreen" class="btn btn-link btn-sm pull-right"
                   href="<?php echo $this->createUrl('/report/departmentSummary/dailyStaff', array('staff'=>$staff,'department' => $this->department)); ?>"><i
