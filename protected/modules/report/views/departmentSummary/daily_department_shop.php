...
$this->breadcrumbs = array(
    ...
    $g => array('/report/departmentSummary/dailyDepartment','department'=>$department),
    $name
);
...
<div class="panel panel-default padding-10">
    <div class="panel-body">
        <?php if (!$full) { ?>
            <legend>Department Summary: <?php echo $g; ?> - <?php echo $name; ?> (<?php echo $date; ?>)
                <a title="Fullscreen" class="btn btn-link btn-sm pull-right"
                   href="<?php echo $this->createUrl('/report/departmentSummary/dailyDepartmentShop', array('shop'=>$this->shop, 'full' => 1, 'department' => $department)); ?>"><i
        ...
        <?php } else { ?>
            ...
            <legend class="text-primary">Teamkenko Department Summary
                ...
                <a title="Exit fullscreen" class="btn btn-link btn-sm pull-right"
                   href="<?php echo $this->createUrl('/report/departmentSummary/dailyDepartmentShop', array('shop'=>$this->shop,'department' => $department)) ?>"><i
                ...
                'columns' => array(
                    array(
                        ...
                        'value' => function ($data) {
                            ...
                            if ($profile != null) {
                                return CHtml::link($profile->getFullName(),Yii::app()->createUrl('/report/departmentSummary/dailyStaffDepartmentShop',array('staff'=>$data['assign_id'],'shop'=>Yii::app()->getController()->shop, 'department'=>Yii::app()->getController()->department)));
                            }
                            return '';
                        }
                    ),
