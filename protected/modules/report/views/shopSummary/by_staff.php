...
$this->breadcrumbs = array(
    ...
    $g => array('/report/shopSummary/shop', 'shop' => $this->shop),
    $name
);
...
<div class="panel panel-default padding-10">
    <div class="panel-body">
        <?php if (!$full) { ?>
            <legend>Shop Summary: <?php echo $g; ?> - <?php echo $name; ?>
                <a title="Fullscreen" class="btn btn-link btn-sm pull-right"
                   href="<?php echo $this->createUrl('/report/shopSummary/staff', array('full' => 1, 'staff' => $staff, 'shop' => ($this->shop > 0) ? $shopModel->id : -1)); ?>"><i
        ...
        <?php } else { ?>
            ...
            <legend class="text-primary">Teamkenko Shop Summary
                ...
                <a title="Exit fullscreen" class="btn btn-link btn-sm pull-right"
                   href="<?php echo $this->createUrl('/report/shopSummary/staff', array('staff' => $staff, 'shop' => ($this->shop > 0) ? $shopModel->id : -1)) ?>"><i
