...
$this->breadcrumbs = array(
    'Daily Staff Summary' => array('/report/staffSummary/daily'),
    $name
);
...
<div class="panel panel-default padding-10">
    <div class="panel-body">
        <?php if (!$full) { ?>
            <legend>Staff Summary: <?php echo $name; ?>  (<?php echo $date; ?>)
                <a title="Fullscreen" class="btn btn-link btn-sm pull-right"
                   href="<?php echo $this->createUrl('/report/staffSummary/dailyStaff', array('full' => 1,'staff'=>$staff)); ?>"><i
                        class="glyphicon glyphicon-fullscreen"></i></a>
            </legend>
        <?php } else { ?>
            <head>
                <meta http-equiv="refresh" content="60">
                <title><?php echo Yii::app()->name; ?> - <?php echo $name; ?> (<?php echo $date; ?>)</title>
            ...
            <legend class="text-primary">Teamkenko Staff Summary
                ...
                <a title="Exit fullscreen" class="btn btn-link btn-sm pull-right"
                   href="<?php echo $this->createUrl('/report/staffSummary/dailyStaff', array('staff'=>$staff)) ?>"><i
