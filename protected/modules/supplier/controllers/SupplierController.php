...
//    }
    ...
    public function actionCreate() {
        ...
        $this->checkAccess('Supplier_Create', array(), true);
        ...
        if (isset($_POST['Supplier'])) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash('successMessage', 'Created Contact successful');
    ...
    public function actionUpdate($id) {
        ...
        $this->checkAccess('Supplier_View', array(), true);
        ...
        if (isset($_POST['Supplier'])) {
            ...
            $this->checkAccess('Supplier_Update', array(), true);

            $model->attributes = $_POST['Supplier'];
            if ($model->save()) {
                Yii::app()->user->setFlash('successMessage', 'Updated Contact successful');
    ...
    public function actionDelete($id) {
        ...
        $this->checkAccess('Supplier_Delete', array(), true);
...
//    }
    ...
    public function actionAdmin() {
        ...
        $this->checkAccess('Supplier_List', array(), true);
    ...
    public function renderActionButton($data, $row, $dataColumn) {
        ...
        if ($this->checkAccess("Supplier_Delete", array())) {
            $buttons[] = array(
                'label' => 'Delete',
                'url' => Yii::app()->createUrl("/supplier/supplier/delete", array("id" => $data->id)),
