...
//    public static function registerMomentJs(){
//        $path      = dirname(__FILE__) . DIRECTORY_SEPARATOR . 'assets';
//        $assetsUrl = Yii::app()->assetManager->publish($path, false, -1, Yii::app()->assetManager->forceCopy);
//
//        Yii::app()->clientScript->registerScriptFile($assetsUrl.'/moment.min.js', ClientScript::POS_END);
//    }
    ...
    public function registerClientScript()
    {
        ...
        Yii::app()->getClientScript()->registerScriptFile(Yii::app()->controller->getAssetsBase(). '/momentjs/moment.js',ClientScript::POS_END);
