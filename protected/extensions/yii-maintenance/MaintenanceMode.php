...
//    public $roles = array('Administrator',);
    ...
    public function init() {
        ...
        if ($this->enabledMode && Yii::app() instanceof CConsoleApplication) {
            Yii::app()->end();
            exit;
        }
...
//            }
            ...
            if (!$disable) {
                if ($this->capUrl === 'maintenance/index') {
                    Yii::app()->controllerMap['maintenance'] = 'yiimaintenance.MaintenanceController';
                }
